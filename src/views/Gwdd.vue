    ...
    <div class="div1">
      ...
      <div class="div1-2">
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="address" label="现部门和岗位"  width="150"></el-table-column>
          <el-table-column prop="address1" label="新部门和岗位" width="160"></el-table-column>
          <el-table-column prop="address2" label="调动类型" width="170"></el-table-column>
        </el-table>
        <div class="aaa">
